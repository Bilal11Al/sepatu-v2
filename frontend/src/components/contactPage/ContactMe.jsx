                ...
                <div className="bg-gray-300 p-2 px-5 py-10 ">
                    ...
                    <div className="mt-5">
                        ...
                        <div className="flex items-center px-5 mt-2 gap-1">
                            <div className="bg-black p-2 rounded-full hover:bg-blue-400"><FaInstagram className="w-6 h-6 text-white" /></div>
                            <div className="bg-black p-2 rounded-full hover:bg-blue-400"><FaTiktok className="w-6 h-6 text-white" /></div>
                            <div className="bg-black p-2 rounded-full hover:bg-blue-400"><FaFacebook className="w-6 h-6 text-white" /></div>
                        </div>
                    </div>
                </div>
